            ...
            >
              ...
              <div>
                ...
                <div
                  ...
                  className="hidden mt-2 -mb-4 text-sm text-red-400"
                >
                  This email you have provided is already associated with an
                  account. Click
                  <div className="text-red-400 underline" onClick={(e) => {
                    e.preventDefault();
                    navigate("sign-in")
                  }}>here</div> to
                  sign in.
                  ...
                  >
                    {showPassword ? (
                      ...
                      <svg
                        ...
                        strokeWidth="1.5"
                        stroke="currentColor"
                        className="text-gray-300 hide-password-icon"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
              ...
              <div>
                ...
                <span className="text-sm text-gray-300">
                  ...
                  <a href="terms.html" className="text-sm text-blue-500 underline"
                  >Terms & Conditions
                  </a>
                  and acknowledge our
                  <a href="privacy.html" className="text-sm text-blue-500 underline"
                  >Privacy Policy
                  </a>.
                </span>
              </div>
